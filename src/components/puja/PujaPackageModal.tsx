              ...
              {(puja.prices || []).map((tier, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`relative rounded-2xl border-2 overflow-hidden text-center transition-all ${
                      isSelected
                  ...
                  >
                    {/* Radio indicator */}
                    <div className={`absolute top-2.5 right-2.5 h-5 w-5 rounded-full border-2 flex items-center justify-center transition-all z-10 ${
                    ...
                    {/* Label + price */}
                    <div className={`px-3 py-2.5 ${isSelected ? "bg-saffron/5" : "bg-cream"}`}>
                      <p className="text-sm font-bold text-maroon leading-tight">{tier.label}</p>
                      <p className="text-base font-bold text-saffron mt-0.5">₹{tier.price.toLocaleString("en-IN")}</p>
                    </div>
                  </button>
                );
              })}
