    ...
    return (
      <main className="min-h-[60vh] bg-background flex items-center justify-center">
        <div className="text-center px-4 py-20">
          ...
          <h1 className="font-display text-3xl text-maroon md:text-4xl">Your Cart is Empty</h1>
          <p className="mt-3 font-serif italic text-brown/70 max-w-md mx-auto">
            Begin your spiritual journey — add sacred pujas or chadhava offerings to your cart.
          </p>
      ...
      <div className="bg-gradient-to-r from-maroon via-maroon-deep to-maroon py-10">
        <div className="container">
          ...
          <h1 className="font-display text-3xl text-gold md:text-4xl flex items-center gap-3">
            <ShoppingCart size={32} /> Your Sacred Cart
          </h1>
          <p className="mt-1 font-serif italic text-cream/70">Review your offerings before checkout</p>
        </div>
      </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_380px]">
          ...
          <div className="space-y-4">
            ...
            {items.map((item) => (
              ...
              >
                {/* Remove item absolute on mobile, grid col on desktop */}
                <button
                ...
                {/* Quantity and Price Container (Row on mobile, Grid items on desktop) */}
          ...
          <div className="h-fit sticky top-32 rounded-2xl border border-gold/60 bg-gradient-to-b from-ivory to-cream p-6 shadow-lg relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-5 pointer-events-none" style={{ backgroundImage: "radial-gradient(var(--tw-gradient-stops))", '--tw-gradient-from': '#000', '--tw-gradient-stops': 'var(--tw-gradient-from), var(--tw-gradient-to, rgba(0, 0, 0, 0))' } as React.CSSProperties}></div>
            ...
            >
              <span className="relative z-10 flex items-center justify-center gap-2">
                 Proceed to Checkout <ArrowLeft size={16} className="rotate-180 transition-transform group-hover:translate-x-1" />
              </span>
            </Link>

            <p className="mt-5 text-center text-[11px] text-brown/60 font-serif italic relative z-10">
              Secure checkout • Prasad delivered to your doorstep
            </p>
          </div>
        </div>
      </div>
